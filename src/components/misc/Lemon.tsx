    ...
    <div className={`relative ${className ? className : ""}`} onClick={onClick}>
      ...
      {checked ? (
        <img
          src={check}
          alt="check"
          className="absolute bottom-[0.5rem] right-[0.5rem] w-[2.625rem] h-[2.625rem]"
        />
      ) : (
        <span
          className={`font-inter font-black text-center rounded-full absolute flex justify-center items-center ${
            color === "white"
