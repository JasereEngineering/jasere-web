    ...
    <AppLayout className="flex flex-col font-inter text-[0.938rem] leading-[1.5em] tracking-[0.25px] pt-[8rem] px-[1.125rem] pb-[2.875rem] bg-black">
      <div>
        ...
        <ul className="mb-4 pl-[1.125rem]">
          <li>
            Eligibility: You must be at least 13 years old to use the Jasere
            app. By using the app, you confirm that you are at least 13 years
            old.
          </li>
          <li>
        ...
        <ul className="mb-4 pl-[1.125rem]">
          <li>
            ...
            upload, post, or share within the app. Jasere does not endorse any
        ...
        <ul className="mb-4 pl-[1.125rem]">
          <li>
            Ownership: All intellectual property rights in the app, including
            but not limited to text, graphics, logos, and software, are owned by
            or licensed to Jasere.
          </li>
          <li>
            Restrictions: You may not reproduce, distribute, or create
            derivative works based on the app's content without express written
            permission from Jasere.
          </li>
        </ul>

        <h4 className="font-semibold">6. Termination:</h4>
        <p className="mb-4">
          Jasere reserves the right to terminate or suspend your access to the
          app at any time, with or without notice, for any reason, including but
